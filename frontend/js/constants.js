const contractAddress = "0x84ce22c220fd8BA55855Af4Baad56Cf5558B6e06"; //Replace with your own contract address
const chain = 'rinkeby'; // rinkeby or polygon

const welcome_h1 = "Welcome to Elyohim!";
const welcome_h2 = "Connect to MetaMask to Get Started";
const welcome_p = 'Elyohim is a decentralized, open-source project that aims to demonstrate how to develop and launch your own NFT Collection. Follow step by step on the <a href="https://youtube.com/codestackr"  target="_blank" rel="noopener noreferrer">codeSTACKr</a> YouTube channel.';
